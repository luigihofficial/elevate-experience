    ...
    <div style="max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #e7ddc9;border-radius:14px;overflow:hidden">
      ...
      <div style="padding:26px">
        ...
        <div style="text-align:center;margin:10px 0 6px">
          <img src="${qrUrl}" alt="C&oacute;digo QR de tu ticket" width="180" height="180" style="border:8px solid #ffffff;border-radius:10px;background:#fff">
        ...
        <table style="width:100%;font-size:14px;color:#1C3A5E;border-top:1px solid #eee;padding-top:12px">
          <tr><td style="padding:4px 0;color:#C0392B;font-weight:bold">Evento suspendido hasta nuevo aviso</td></tr>
          <tr><td style="padding:4px 0"><span style="text-decoration:line-through;text-decoration-color:#C0392B"><b>S&aacute;bado 5 de septiembre de 2026</b> &middot; 10:00 a.m. a 2:00 p.m.</span></td></tr>
          <tr><td style="padding:4px 0"><span style="text-decoration:line-through;text-decoration-color:#C0392B">Embassy Suites by Hilton &mdash; Miami International Airport</span></td></tr>
          <tr><td style="padding:4px 0;color:#6B7585"><span style="text-decoration:line-through;text-decoration-color:#C0392B">3974 NW S River Dr, Miami, FL 33142</span></td></tr>
        </table>
